...
def create_correlation_heatmap():
    ...
    train_ml_path = '/mnt/p/coddd/Capstone_group4/ml/Train_ML.csv'
    ...
    plt.tight_layout()
    plt.savefig('ml/correlation_matrix_full.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('ml/correlation_matrix_filtered.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('ml/feature_importance_heatmap.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    print("\nĐã lưu heatmap vào các file trong thư mục ml")
